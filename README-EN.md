...
If you use the official DeepSeek API, switch to:
...
# Optional: enabled / disabled / auto
DEEPSEEK_THINKING_MODE=disabled
DEEPSEEK_REASONING_EFFORT=high
ZEP_API_KEY=your_zep_api_key
```

Compatibility note: legacy `deepseek-chat` / `deepseek-reasoner` are now auto-mapped in code to DeepSeek V4 as `deepseek-v4-flash` non-thinking / thinking mode respectively. DeepSeek's official docs say those legacy names will be retired on July 24, 2026, so switching to the explicit V4 names is still recommended.
