...
from ..utils.atomic_file import write_csv_file, write_json_file
...
class AgentRelationshipEdge:
    ...
    def to_dict(self) -> Dict[str, Any]:
        return {
            ...
            "source_region_id": self.source_region_id,
            "target_region_id": self.target_region_id,
            "relation_label": self.relation_label or self.relation_type,
            "mechanism": self.mechanism or self.rationale,
            "trigger_conditions": list(dict.fromkeys(self.trigger_conditions)),
            "latency": self.latency,
            "direction": self.direction,
            "scope": self.scope,
            "evidence": list(dict.fromkeys(self.evidence)),
            "confidence": clamp_probability(self.confidence or self.strength),
